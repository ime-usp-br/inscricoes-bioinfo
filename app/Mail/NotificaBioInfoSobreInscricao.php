...
class NotificaBioInfoSobreInscricao extends Mailable
{
    ...
    public function attachments(): array
    {
        ...
        foreach($this->inscricao->anexos as $anexo){
            $anexos[] = Attachment::fromPath(base_path() . '/storage/app/' .$anexo->caminho)->as($anexo->nome);
        }
